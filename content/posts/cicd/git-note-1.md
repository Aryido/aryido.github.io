...
date: 2025-04-30T21:53:19+08:00
...
兩者都是 「Git 撤消 commit」 的一種形式，但是 revert 和 reset 的不同點是 `git revert` 是會**增加一個反操作的 commit** :
...
雖然用 Git 來做版本管理時，偶爾會需要**撤銷**某些操作，但對於已經推上遠端 Github / Gitlab repository 的程式碼，並且該分支已經有多人協作的時候，**撤銷**操作就不能隨便做了！
