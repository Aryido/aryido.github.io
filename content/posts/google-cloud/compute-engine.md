...
- **_General Purpose (E2、N2、N2D、N1)_** : 一般性的使用。
- **_Compute Optimized (C2)_** : 需要高速運算的 Application 例如 game server。
- **_Memory Optimized (M2、M1)_** : 這通常是給需要大量記憶體的 DB 或分析工具使用。
